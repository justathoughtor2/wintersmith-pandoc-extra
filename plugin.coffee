...
#mermaidRender = (page, callback) ->
# page.markdown = page.markdown.replace(/(\n\s*mermaid)(\s*)(((\s{4})*([\s\S][^#])*)(\n)(\n+))/g, '<div class="mermaid">$2$3</div>')
# console.log(page.markdown)
# callback null, page

mermaidFix = (page, callback) ->
 page._htmlraw = page._htmlraw.replace(/(<pre><code>mermaid)(\d+)([\s\S\n]*)(endmermaid)(\2)(<\/code><\/pre>)/g, '<div class="mermaid">$3</div>')
 console.log(page._htmlraw)
 callback null, page
